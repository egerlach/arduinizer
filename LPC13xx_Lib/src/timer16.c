 ...
 *   2010 			 1.02    Additional Code Red updates
 *
******************************************************************************/
...
/* ===================
 * CodeRed - Modified original NXP code to extract out interrupt handler related code,
...
/* ===================
 * CodeRed - function delayMs changes to delay_microseconds
 * =================== */
/*****************************************************************************
